...
\begin{frame}
    ...
    with 
    \begin{equation*}
        w^{\rho}_{ct} = \sum_{i\in c} \dfrac{e_i}{E_c}\,w^{\rho}_{it} \quad\text{and}\quad w^{\rho}_{it} = \sum_{o\in i} \dfrac{e_o}{E_i}\,w^{\rho}_{oit}
    \end{equation*}
    and
    \vspace{9pt}
    \begin{wideitemize}
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[scale=0.4]{mop010unemprate.png}
    \end{center}

    \hyperlink{perc_comparison_1}{\beamerbutton{Percentiles comparison}}
    \hyperlink{dist_1}{\beamerbutton{Distributions}}
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[scale=0.4]{mop010unemp.png}
    \end{center}

    \hyperlink{perc_comparison_2}{\beamerbutton{Percentiles comparison}}
    \hyperlink{dist_2}{\beamerbutton{Distributions}}
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[scale=0.4]{mop010emp.png}
    \end{center}

    \hyperlink{perc_comparison_3}{\beamerbutton{Percentiles comparison}}
    \hyperlink{dist_3}{\beamerbutton{Distributions}}
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[scale=0.4]{mop010labforce.png}
    \end{center}

    \hyperlink{perc_comparison_4}{\beamerbutton{Percentiles comparison}}
    \hyperlink{dist_4}{\beamerbutton{Distributions}}
